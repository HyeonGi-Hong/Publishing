...
// todo.2 현재 자신이 춥다, 아니다를 cold 변수에 담아 자료형을 check하기.
function booleanCheck(){
     var cold = true;
     console.log('cold 의 자료 유형은' + typeof(cold) + '이고, 값은 true입니다.' + '즉 true 는 춥다 입니다.');
}

// todo.3 현재 로그인 상태가 아니다를 loginStatus 변수에 담아 자료형을 check 해보자.
    function check2(){
        var loginStatus = false;
        console.log('loginStatus의 자료형은' + typeof(loginStatus) + '이고 로그인 상태가 아닙니다');
    }
